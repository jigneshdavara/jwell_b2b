...
export default function AdminDiamondTypesIndex() {
    ...
    const populateForm = (type: DiamondTypeRow) => {
        setEditingType(type);
        form.setData({
            name: type.name,
            ...
            <div className="space-y-8">
                <div className="rounded-3xl bg-white p-6 shadow-xl shadow-slate-900/10 ring-1 ring-slate-200/80">
                    ...
                    <p className="mt-2 text-sm text-slate-500">
                        Manage gemstone types such as natural, lab-grown, or fancy stones to streamline catalogue tagging.
                    </p>
                </div>
                ...
                >
                    ...
                    <label className="flex flex-col gap-2 text-sm text-slate-600">
                        ...
                        <textarea
                            ...
                            placeholder="Optional details (e.g. certification norms, suppliers)."
                        />
