...
export default function AdminUserGroupsIndex() {
    ...
    const handlePerPageChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        router.get(route('admin.users.groups.index'), { per_page: newPerPage }, { preserveState: true, preserveScroll: true });
    };
                                ...
                                <tr key={group.id} className="hover:bg-slate-50">
                                    ...
                                    <td className="px-5 py-3 align-top font-semibold text-slate-900">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <span className="text-xs text-slate-400">Slug: {group.slug}</span>
                                        </div>
                                    </td>
