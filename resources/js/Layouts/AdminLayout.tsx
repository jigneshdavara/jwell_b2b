...
const adminNavigation: NavItem[] = [
    ...
    { label: 'Rates', route: 'admin.rates.index', match: 'admin.rates.*', icon: 'activity' },
    {
        ...
        icon: 'cog',
        children: [
            { label: 'General', route: 'admin.settings.general.index', match: 'admin.settings.general.*', icon: 'cog' },
            { label: 'Tax Groups', route: 'admin.settings.tax-groups.index', match: 'admin.settings.tax-groups.*', icon: 'collection' },
            { label: 'Tax', route: 'admin.settings.taxes.index', match: 'admin.settings.taxes.*', icon: 'receipt' },
