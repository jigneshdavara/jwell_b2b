...
import { CreateOrderStatusDto, UpdateOrderStatusDto, BulkDestroyOrderStatusesDto } from './dto/order-status.dto';
...
export class OrderStatusesService {
  ...
  async create(dto: CreateOrderStatusDto) {
    ...
    if (existing) {
      throw new BadRequestException('Order status with this name already exists');
    }
