...
import { CreateMetalPurityDto, UpdateMetalPurityDto, BulkDestroyDto } from './dto/metal-purity.dto';
...
export class MetalPuritiesController {
  ...
  @Patch(':id')
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateMetalPurityDto) {
