...
import { CreateMakingChargeDiscountDto, UpdateMakingChargeDiscountDto } from './dto/making-charge-discount.dto';
  ...
  async create(dto: CreateMakingChargeDiscountDto) {
    return await this.prisma.making_charge_discounts.create({
      data: {
        ...
        customer_group_id: dto.customer_group_id ? BigInt(dto.customer_group_id) : null,
  ...
  async update(id: number, dto: UpdateMakingChargeDiscountDto) {
    ...
    return await this.prisma.making_charge_discounts.update({
      ...
      data: {
        ...
        customer_group_id: dto.customer_group_id ? BigInt(dto.customer_group_id) : undefined,
        min_cart_total: dto.min_cart_total,
        is_auto: dto.is_auto,
