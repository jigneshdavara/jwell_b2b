...
import { CreateDiamondShapeSizeDto, UpdateDiamondShapeSizeDto, BulkDestroyDto } from './dto/diamond-shape-size.dto';
import { JwtAuthGuard } from '../../../common/auth/guards/jwt-auth.guard';

@Controller('admin/diamond/shape-sizes')
@UseGuards(JwtAuthGuard)
export class DiamondShapeSizesController {
  constructor(private readonly diamondShapeSizesService: DiamondShapeSizesService) {}
  ...
  @Patch(':id')
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateDiamondShapeSizeDto) {
