...
import { CreateDiamondClarityDto, UpdateDiamondClarityDto, BulkDestroyDto } from './dto/diamond-clarity.dto';
import { JwtAuthGuard } from '../../../common/auth/guards/jwt-auth.guard';

@Controller('admin/diamond/clarities')
@UseGuards(JwtAuthGuard)
export class DiamondClaritiesController {
  constructor(private readonly diamondClaritiesService: DiamondClaritiesService) {}
  ...
  @Patch(':id')
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateDiamondClarityDto) {
