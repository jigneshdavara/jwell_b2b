...
import { CreateDiamondTypeDto, UpdateDiamondTypeDto, BulkDestroyDto } from './dto/diamond-type.dto';
...
export class DiamondTypesController {
  ...
  @Patch(':id')
  update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateDiamondTypeDto) {
