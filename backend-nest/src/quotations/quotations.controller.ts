...
import { CreateQuotationDto, StoreQuotationMessageDto } from './dto/quotation.dto';
...
export class QuotationsController {
  ...
  findOne(@Param('id', ParseIntPipe) id: number, @Request() req) {
    return this.quotationsService.findOneFrontend(id, BigInt(req.user.userId));
  }
  ...
  addMessage(
    ...
    return this.quotationsService.addMessage(id, dto.message, BigInt(req.user.userId), 'customer');
  }
