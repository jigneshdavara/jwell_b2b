...
const featureOptions: FeatureOption[] = [
    ...
    { value: "manage_rates", label: "Manage rates" },
    { value: "view_reports", label: "View reports" }
];

const mockGroups: UserGroupRow[] = [
    { id: 1, name: "Inventory Manager", slug: "inventory-manager", description: "Responsible for product stock and variants.", is_active: true, position: 1, features: ["manage_products", "manage_rates"] },
    { id: 2, name: "Sales Operations", slug: "sales-ops", description: "Handles order fulfillment and customer support.", is_active: true, position: 2, features: ["manage_orders", "manage_customers"] },
    { id: 3, name: "Super Admin", slug: "super-admin", description: "Full system access.", is_active: true, position: 0, features: [] }
];
    ...
    const submit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        setTimeout(() => {
            if (editingGroup) {
                setGroups(prev => ({
                    ...prev,
                    data: prev.data.map(g => g.id === editingGroup.id ? { ...g, ...formData } : g)
                }));
            } else {
